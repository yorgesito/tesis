...
import pyautogui as autopy  #Libreria que nos va a permitir manipular el mouse

#---------------------------------Declaracion de variables---------------------------------------
anchocam, altocam = 640, 480
cuadro = 100 #Rango donde podemos interactura
anchopanta, altopanta = autopy.size() #Obtenemos las dimensiones de nuestra pantalla
sua = 5 
pubix, pubiy = 0,0
cubix, cubiy = 0,0
    ...
    if len(lista) != 0:
        ...
        if dedos[1]== 1 and dedos[2] == 0:  #Si el indice esta arriba pero el corazon esta abajo
           ...
           #autopy.mouse.move(anchopanta - cubix,cubiy) #Enviamos las coordenadas al Mouse
            autopy.moveTo(anchocam-cubix, cubiy)
